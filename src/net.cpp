...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Equikoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"equikointools.com", "dnsseed.equikointools.com"},
    {"equikoinpool.org", "dnsseed.equikoinpool.org"},
    {"xurious.com", "dnsseed.eqk.xurious.com"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"equikointools.com", "testnet-seed.equikointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Equikoin is probably already running."), addrBind.ToString().c_str());
        else
